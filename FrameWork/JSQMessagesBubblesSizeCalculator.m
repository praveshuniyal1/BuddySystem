                               ...
                               withLayout:(JSQMessagesCollectionViewFlowLayout *)layout
{
   // NSValue *cachedSize = [self.cache objectForKey:@([messageData messageHash])];
     ...
     NSString *strMsg=[[(NSDictionary *)messageData valueForKey:@"jsqmessage"] valueForKey:@"text"];
    NSValue *cachedSize = [self.cache objectForKey:strMsg];
    if (cachedSize != nil) {
 ...
 NSString *strMsg1=[[(NSDictionary *)messageData valueForKey:@"jsqmessage"] valueForKey:@"text"];
   // [self.cache setObject:[NSValue valueWithCGSize:finalSize] forKey:@([messageData messageHash])];
    
    [self.cache setObject:[NSValue valueWithCGSize:finalSize] forKey:strMsg1];
