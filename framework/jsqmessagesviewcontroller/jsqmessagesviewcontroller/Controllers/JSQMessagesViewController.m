...
- (UICollectionViewCell *)collectionView:(JSQMessagesCollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   // NSParameterAssert(messageSenderId != nil);
    ...
    BOOL isMediaMessage =  [[[(NSDictionary *)messageItem valueForKey:@"jsqmessage"] valueForKey:@"isMediaMessage"] boolValue];
    ...
    if (!isMediaMessage) {
        cell.textView.text = [[(NSDictionary *)messageItem valueForKey:@"jsqmessage"] valueForKey:@"text"];
