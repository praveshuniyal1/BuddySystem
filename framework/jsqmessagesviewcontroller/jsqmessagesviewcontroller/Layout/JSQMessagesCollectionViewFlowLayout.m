...
//    else {
    ...
    NSString *strMsg=[[(NSDictionary *)messageItem valueForKey:@"jsqmessage"] valueForKey:@"text"];
        CGRect stringRect = [strMsg  boundingRectWithSize:CGSizeMake(maximumTextWidth, CGFLOAT_MAX)
                                                             options:(NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading)
                                                          attributes:@{ NSFontAttributeName : self.messageBubbleFont }
                                                             context:nil];
    
//   finalSize=[[[(NSDictionary *)messageItem valueForKey:@"jsqmessage"] valueForKey:@"text"] sizeWithFont:[UIFont systemFontOfSize:15] constrainedToSize:CGSizeMake(220, CGFLOAT_MAX) lineBreakMode:NSLineBreakByWordWrapping];
...
//    NSLog(@"%@",[[(NSDictionary *)messageData  valueForKey:@"jsqmessage"] valueForKey:@"senderId"]);
    NSString *messageSender = [[(NSDictionary *)messageData  valueForKey:@"jsqmessage"] valueForKey:@"senderId"];
